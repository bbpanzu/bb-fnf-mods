...
class Character extends FlxSprite
{
	...
	public function playAnim(AnimName:String, Force:Bool = false, Reversed:Bool = false, Frame:Int = 0):Void
	{
		...
		if (curCharacter == "tordbot"){
			if (AnimName == "singLEFT") PlayState.camFollow.setPosition(tordCam[0].x, tordCam[0].y);
			if (AnimName == "singRIGHT") PlayState.camFollow.setPosition(tordCam[1].x, tordCam[1].y);
			if (AnimName == "singUP") PlayState.camFollow.setPosition(tordCam[2].x, tordCam[2].y);
			if (AnimName == "singDOWN") PlayState.camFollow.setPosition(tordCam[3].x, tordCam[3].y);
		}
	}
