	...
	override public function create()
	{
		...
		switch (SONG.song.toLowerCase())
		{
			...
			case "camel":
				defaultCamZoom = 1;
				curStage = 'ankha';
				var wall:BGSprite = new BGSprite('ankha/wall', -181.35, -572.35, 1, 1);
				add(wall);
				var floor:BGSprite = new BGSprite('ankha/floor', -582.6, 528, 1, 1);
				add(floor);
				var toilet:BGSprite = new BGSprite('ankha/toilet', 92.9, 314.85, 1, 1);
				add(toilet);
